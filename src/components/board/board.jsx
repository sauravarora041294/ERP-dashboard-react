...
const Board = () => {
    ...
    const [task, setTask] = useState([
        ...
        { id: "3", name: 'Mary Jane', taskStatus: 'finalcheck', profession: "Owner", company: "Brake on Point", tags: ['HEIDENTIC'] },
        { id: "4", name: 'Ritesh', taskStatus: 'done', profession: "Cook", company: "Origami", tags: ['EVENTS'] },
